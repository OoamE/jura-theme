		...
		<div id="main-slider" class="container">
			<section class="featured-slider">
				...
				<article class="post hentry slides demo-image displayblock">
					<figure class="slider-image">
						<a title="Hotel Restaurant Berthet" href="#">
							<img src="'. get_template_directory_uri() . '/images/demo/kathmandu-durbar-square-1280x600.jpg" class="wp-post-image" alt="Kathmandu Durbar Square" title="Hotel Restaurant Berthet">
						</a>
					</figure>
					<div class="entry-container">
						<header class="entry-header">
							<h1 class="entry-title">
								<a title="Hotel Restaurant Berthet" href="#"><span>Hotel Restaurant Berthet</span></a>
							</h1>
						</header>
						<div class="entry-content">
							<p> Hotel Restaurant Berthet holds the palaces of the Malla and Shah kings who ruled over the city. Along with these palaces, the square surrounds quadrangles revealing courtyards and temples.</p>
						</div>   
					</div>             
				</article><!-- .slides --> 		
